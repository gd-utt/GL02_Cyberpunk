import {
  ...
  SymbolShape,
  TextBaseline
} from 'vega-typings/types/index.js';
import { BaseAxis } from 'vega-typings/types/spec/axis.js';
import { Color } from 'vega-typings/types/spec/color.js';
import { URI } from 'vega-typings/types/spec/data.js';
import {
  Blend,
  ColorValueRef,
  Gradient,
  ...
  Text,
  TextDirection
} from 'vega-typings/types/spec/encode.js';
import { LayoutBounds } from 'vega-typings/types/spec/layout.js';
import { BaseLegend } from 'vega-typings/types/spec/legend.js';
import { Locale } from 'vega-typings/types/spec/locale.js';
import { BaseProjection } from 'vega-typings/types/spec/projection.js';
import { InitSignal, NewSignal, SignalRef } from 'vega-typings/types/spec/signal.js';
import { BaseTitle, TitleAnchor } from 'vega-typings/types/spec/title.js';

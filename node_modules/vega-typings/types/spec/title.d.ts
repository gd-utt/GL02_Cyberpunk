import { GroupEncodeEntry, GuideEncodeEntry, SignalRef, TextEncodeEntry } from 'vega-typings/types/index.js';
import { Encode, Text } from 'vega-typings/types/spec/encode.js';
import {
  AlignValue,
  AnchorValue,
  ColorValue,

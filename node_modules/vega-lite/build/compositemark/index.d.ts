...
import { GenericUnitSpec, NormalizedLayerSpec } from '../../src/spec/index.js';
import { EncodingFacetMapping } from '../../src/spec/facet.js';
import { NormalizedUnitSpec } from '../../src/spec/unit.js';
import { BoxPlot, BoxPlotConfigMixins, BoxPlotDef } from '../../src/compositemark/boxplot.js';
import { ErrorBand, ErrorBandConfigMixins, ErrorBandDef } from '../../src/compositemark/errorband.js';
import { ErrorBar, ErrorBarConfigMixins, ErrorBarDef, ErrorExtraEncoding } from '../../src/compositemark/errorbar.js';
export type { BoxPlotConfig } from '../../src/compositemark/boxplot.js';
export type { ErrorBandConfigMixins } from '../../src/compositemark/errorband.js';
export type { ErrorBarConfigMixins } from '../../src/compositemark/errorbar.js';

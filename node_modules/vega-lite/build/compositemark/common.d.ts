...
import { CompositeMark, CompositeMarkDef } from '../../src/compositemark/index.js';
import { Field, PositionFieldDef, SecondaryFieldDef, StringFieldDef, StringFieldDefWithCondition, StringValueDefWithCondition } from '../../src/channeldef.js';
import { Encoding } from '../../src/encoding.js';
import { ExprRef } from '../../src/expr.js';
import { ColorMixins, GenericMarkDef, Mark, AnyMarkConfig, MarkDef } from '../../src/mark.js';
import { GenericUnitSpec, NormalizedUnitSpec } from '../../src/spec/index.js';

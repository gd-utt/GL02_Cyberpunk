 ...
 */
import { Field, FieldName } from '../../src/channeldef.js';
import { Encoding } from '../../src/encoding.js';
import { DataMixins } from '../../src/spec/base.js';
import { GenericConcatSpec, GenericHConcatSpec, GenericVConcatSpec } from '../../src/spec/concat.js';
import { GenericFacetSpec } from '../../src/spec/facet.js';
import { GenericLayerSpec, LayerSpec, NormalizedLayerSpec } from '../../src/spec/layer.js';
import { RepeatSpec } from '../../src/spec/repeat.js';
import { TopLevel } from '../../src/spec/toplevel.js';
import { FacetedUnitSpec, GenericUnitSpec, NormalizedUnitSpec, TopLevelUnitSpec, UnitSpecWithFrame } from '../../src/spec/unit.js';
export type { BaseSpec, LayoutSizeMixins } from '../../src/spec/base.js';
export type { GenericConcatSpec, GenericHConcatSpec, GenericVConcatSpec, NormalizedConcatSpec } from '../../src/spec/concat.js';
export { isAnyConcatSpec, isHConcatSpec, isVConcatSpec } from '../../src/spec/concat.js';
export type { GenericFacetSpec, NormalizedFacetSpec } from '../../src/spec/facet.js';
export { isFacetSpec } from '../../src/spec/facet.js';
export type { GenericLayerSpec, LayerSpec, NormalizedLayerSpec } from '../../src/spec/layer.js';
export { isLayerSpec } from '../../src/spec/layer.js';
export type { RepeatSpec } from '../../src/spec/repeat.js';
export { isRepeatSpec } from '../../src/spec/repeat.js';
export type { TopLevel } from '../../src/spec/toplevel.js';
export type { FacetedUnitSpec, GenericUnitSpec, NormalizedUnitSpec, UnitSpec, TopLevelUnitSpec, UnitSpecWithFrame, } from '../../src/spec/unit.js';
export { isUnitSpec } from '../../src/spec/unit.js';
/**

...
import { CompositeEncoding, FacetedCompositeEncoding } from '../../src/compositemark/index.js';
import { Encoding } from '../../src/encoding.js';
import { ExprRef } from '../../src/expr.js';
import { AnyMark, Mark, MarkDef } from '../../src/mark.js';
import { Projection } from '../../src/projection.js';
import { SelectionParameter } from '../../src/selection.js';
import { Field } from '../../src/channeldef.js';
import { BaseSpec, DataMixins, FrameMixins, GenericCompositionLayout, ResolveMixins } from '../../src/spec/base.js';
import { TopLevel, TopLevelParameter } from '../../src/spec/toplevel.js';
/**
